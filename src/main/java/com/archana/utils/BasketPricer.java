...
/**
 * A utility class which computes total price for a given basket of fruits.
 * List of individual fruits and prices are fixed and not dynamic.
 * We have a finite number of fruit entries in basket.
 * @Threadsafe
...
public final class BasketPricer {
	...
	/**
	 * This method iterates through the fruit list and computes sum of
	 * all the individual prices in fruit entry-set.
	 * @Threadsafe
	 * @param fruitsBasket
	 * @return totalPrice for the fruit basket
	 */

	final static BigDecimal calculateBasketPrice(List<? extends IFruit> fruitsBasket) {
...
/**
 * Interface to elements in basket
 * Any object to be placed in Basket should implement this.
 *
 */
